...
fe_estimates_bateman_st <- ggplot(dens_df, aes(x = x, y = y, color = group)) +
  ...
  # reference at 0
  geom_vline(xintercept = 0, linetype = "dashed") +
  labs(x = "Posterior distribution of stand. slope", y = "Density") +
...
ma_estimates_st <- ggplot(dens_df, aes(x = x, y = y, color = group)) +
  ...
  # reference at 0
  geom_vline(xintercept = 0, linetype = "dashed") +
  labs(x = "Posterior distribution of stand. slopes", y = "Density") +
...
ggsave("figures/black coucals/Fig1_gradients_BC.png", plot = multi_panel ,  width = 21, height = 10, dpi = 300)
...
sexual_selection    <- varZ * betaRM_sims * betaMZ_sims
remaining_selection <- varZ * betaRZ_sims
total_selection    <- sexual_selection_q + remaining_selection_q
...
# ============================================================
summary_pathcoeff <- data.frame(
  Component = rep(c("Linear (Z.l)", "Quadratic (Z.q)", "Combined"), each = 3),
  Parameter = rep(c("Sexual Selection", "Remaining Selection", "Total Selection"), times = 3),
  Mean = round(c(
  ...
  lowerCrl = round(c(
    quantile(sexual_selection_l, 0.025),
