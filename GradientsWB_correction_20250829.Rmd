...
# Panel B
panelB <- arrangeGrob(females_st, nullGrob(), males_st, nrow = 1, widths = c(1.5, 0.2, 1))
...
ggsave("figures/whitebrowed coucals/Fig2_gradients_WC.png", plot = multi_panel ,  width = 15, height = 7, dpi = 300)
