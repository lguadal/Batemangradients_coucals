...
custom_theme <- theme_classic() +
  theme(
    ...
    axis.title.x = element_text(size = 25),      # x-axis label
    axis.title.y = element_text(size = 25),  # y-axis label (markdown allowed)
...
estimates_InterandSlopes <- ggplot(dens_df_AME, aes(x = x, y = y, color = group)) +
  ...
  labs(x = "Posterior distrib. of slopes", 
       y = "Density") +
...
panelA <- arrangeGrob(textGrob("A", x = 0, y = 1, just = c("left","top"), gp = gpar(fontsize = 42, fontface = "bold")),
                      panelA, ncol = 1, heights = c(0.1, 1))

# Panel B
panelB <- arrangeGrob(females_plot_s, nullGrob(), males_plot_s, nrow = 1, widths = c(2, 0.05, 1))
panelB <- arrangeGrob(textGrob("B", x = 0, y = 1, just = c("left","top"), gp = gpar(fontsize = 42, fontface = "bold")),
                      panelB, ncol = 1, heights = c(0.1, 1))

#Panel C
panelC<- estimates_InterandSlopes
panelC <- arrangeGrob(textGrob("C", x = 0, y = 1, just = c("left","top"), gp = gpar(fontsize = 42, fontface = "bold")),
...
panelD <- arrangeGrob(textGrob("D", x = 0, y = 1, just = c("left","top"), gp = gpar(fontsize = 42, fontface = "bold")),
...
ggsave(
  ...
  plot = multi_panel,
  width = 38,    # ↓ narrower overall
  height = 18,   # you can adjust this too for balance
  dpi = 300,
   limitsize = FALSE,
  bg = "white"
)
