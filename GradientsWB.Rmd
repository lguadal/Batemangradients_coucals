...
#ggsave("figures/whitebrowed coucals/Fig2_gradients_WC.png", plot = multi_panel ,  width = 21, height = 10, dpi = 300)


ggsave("figures/whitebrowed coucals/Fig2_gradients_WC_alternative.png", plot = multi_panel ,
